...
$findcustomers=mysqli_query($db,"SELECT * FROM usersi WHERE role='customers' AND name like '%{$search_word}%'");

if(mysqli_num_rows($findcustomers)==0){
    echo "No searh matches!!";
}
while($searchedcustom=mysqli_fetch_assoc($findcustomers)){
