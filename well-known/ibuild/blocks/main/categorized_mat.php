<?php
$query=mysqli_query($db,"SELECT * FROM items WHERE category='bricks' AND deleted='0'");
$query1=mysqli_query($db,"SELECT * FROM items WHERE category='rods' AND deleted='0'");
$query2=mysqli_query($db,"SELECT * FROM items WHERE category='cement' AND deleted='0'");
$query3=mysqli_query($db,"SELECT * FROM items WHERE category='sand' AND deleted='0'");
$query4=mysqli_query($db,"SELECT * FROM items WHERE category='gravel' AND deleted='0'");
$query5=mysqli_query($db,"SELECT * FROM items WHERE category='blocks' AND deleted='0'");

$query6=mysqli_query($db,"SELECT * FROM items WHERE category='others' AND deleted='0'");
