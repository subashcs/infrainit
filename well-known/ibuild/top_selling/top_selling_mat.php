...
$query=mysqli_query($db,"SELECT * FROM items WHERE category='bricks' AND deleted='0' ORDER BY sales DESC LIMIT 5");
$query1=mysqli_query($db,"SELECT * FROM items WHERE category='rods' AND deleted='0' ORDER BY sales DESC LIMIT 5");
$query2=mysqli_query($db,"SELECT * FROM items WHERE category='cement' AND deleted='0' ORDER BY sales DESC LIMIT 5");
$query3=mysqli_query($db,"SELECT * FROM items WHERE category='sand' AND deleted='0' ORDER BY sales DESC LIMIT 5");
$query4=mysqli_query($db,"SELECT * FROM items WHERE category='gravel' AND deleted='0' ORDER BY sales DESC LIMIT 5");
$query5=mysqli_query($db,"SELECT * FROM items WHERE category='blocks' AND deleted='0' ORDER BY sales DESC LIMIT 5");

$query6=mysqli_query($db,"SELECT * FROM items WHERE category='others' AND deleted='0' ORDER BY sales DESC LIMIT 5");
