...
<head>
  ...
  <meta name="description" content="Consult to experts about your infrastructure problems such as house remedies , architectural problems , decorations etc.">
  ...
  $bool_log=0;
    ...
    ?>
      ...
      <?php
              ...
              $sql = "SELECT COUNT(*) FROM queries WHERE question LIKE '%$search%' ";
              ...
              $sql = "SELECT * FROM queries WHERE question LIKE '%$search%' ORDER BY que_id DESC LIMIT $rowsperpage OFFSET $offset";
        ...
        ?>
      <div>
           <a href="accounts.php" class="col-sm-3 container-fluid">
           <?php
    ...
    ?>
           ...
           <div class="col-sm-12" style="padding:1%;"><!--for answers-->
             ...
             <a class="col-sm-3" href="accounts.php">
            <?php
